    ...
    <div class="bg-gray-800 m-0 p-0 h-screen font-poppins">
        ...
        <div class="flex flex-col items-center">
            ...
            <div v-if="useGameState != 'finish'"
                 class="bg-orange-500/80 ring-1 ring-orange-800 h-96 w-1/2 rounded-lg flex justify-center items-center text-gray-600 font-bold text-xl select-none cursor-pointer"
                 @click="startCpsCounter">
                <p v-if="clicks != 0">{{ clicks }}</p>
                <p v-else>Click in the orange rectangle to start</p>
            </div>
